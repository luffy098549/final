...
def get_database_url() -> str:
    ...
    if json_url and 'localhost' not in json_url:
        print("✅ DATABASE_URL cargada desde config.json")
        return json_url
...
# ================================================================
# FLASK CONFIG — DICCIONARIO DIRECTO (SIN connect_args SSL)
# ================================================================
...
def get_flask_config() -> dict:
    ...
    config = {
        # Base de datos — SIN connect_args para evitar conflicto SSL
...
# ================================================================
# COMPATIBILIDAD — flask_config para imports existentes
# ================================================================
